...
message1 =
  Message.create!(body: 'Hello, Dr. Pym!', conversation_id: 1, user_id: 1)

message2 = Message.create!(body: 'Hello Scott!', conversation_id: 1, user_id: 2)
...
message2 =
  Message.create!(body: 'Where are you from?', conversation_id: 2, user_id: 7)
